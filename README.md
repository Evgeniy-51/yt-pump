...
**Скачивайте видео с YouTube в нужном качестве — в пару кликов.** Вставьте ссылку, выберите разрешение, звуковую дорожку и формат (MKV, MP4 или только аудио) — готово. Портативная программа для Windows: ничего не нужно устанавливать.

Под капотом — [yt-dlp](https://github.com/yt-dlp/yt-dlp) и FFmpeg.
